...
const About = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-600 to-green-200 flex items-center justify-center py-12">
      <div className="bg-white rounded-2xl shadow-lg max-w-5xl w-full mx-4 p-0 overflow-hidden">
        <div className="grid md:grid-cols-2 gap-0">
          ...
          <div className="flex flex-col justify-center px-8 py-12">
            ...
            <button className="flex items-center bg-green-600 hover:bg-green-400 text-white font-semibold px-6 py-2 rounded transition w-max mb-8">
              EXPLORE MORE
              <span className="ml-2 text-xl">&#8594;</span>
            </button>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-8">
              <div className="text-center">
                <span className="text-3xl font-bold text-green-400">75m+</span>
                <div className="text-xs text-gray-600 mt-1">STUDENTS LEARNING</div>
              </div>
              <div className="text-center">
                <span className="text-3xl font-bold text-green-400">7,000+</span>
              ...
              <div className="text-center">
                <span className="text-3xl font-bold text-green-400">85k+</span>
